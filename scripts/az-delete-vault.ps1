...
$VaultName = "vault-lmpqoaqf" #fetch automatically
$Subscription = "learn-subscription" #fetch automatically
$ResourceGroup = "rg-learn-01" #fetch automatically
$SubscriptionId = "b48c4208-ed65-40c3-aa56-7560ab152a46" #fetch automatically
