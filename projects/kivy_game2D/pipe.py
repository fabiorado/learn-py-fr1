...
class Pipe(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self.pipe_body_texture = Image(source='img/pipe_body.png').texture
        self.pipe_body_texture.wrap = 'repeat'

    def on_size(self, *args):
        lower_body_size = self.bottom_cap_position - self.bottom_body_position
        self.lower_pipe_tex_coords[5] = lower_body_size/20 #height of my pipe body
        self.lower_pipe_tex_coords[7] = lower_body_size/20 #height of my pipe body
